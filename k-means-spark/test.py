...
print("2-dimension-inf ****",abs(p.distance(q, np.inf) - 1.0) < 0.0001)
...
print("3-dimension-inf ****",abs(p.distance(q, np.inf) - 3.0) < 0.0001)
...
print("7-dimension-inf ****",abs(p.distance(q, np.inf) - 5.0) < 0.0001)
